...
const Login = ({ signedOn, setSignedOn }) => {
  ...
  if (signedOn) {
    ...
    return (
      <div className={` pt-[4.875rem] h-full w-full relative overflow-hidden`}>
        ...
        >
          <SignInForm
            handleSucccessfulLogin={handleSucccessfulLogin}
            mobileLinkClicked={mobileLinkClicked}
            setMobileLinkClicked={setMobileLinkClicked}
        ...
        <div
          ...
          className={`hidden md:block absolute top-0 left-[60%] w-[40%] h-full overflow-hidden  transition-transform duration-700 ease-in-out z-100 ${
        ...
        >
          ...
          >
            <div
              id="overlay-left"
              className={`w-1/2 h-full absolute flex justify-center items-center top-0 transform -translate-x-[0%] transition-transform duration-700 ease-in-out ${
